...
<style>
    ...
    .main-logo { font-family: 'Times New Roman', serif; font-size: 3.2em; font-weight: bold; margin: 0; text-shadow: 2px 2px 4px rgba(0,0,0,0.3); }
    .sub-logo { font-size: 1.2em; color: #ffcc00; font-weight: 300; text-transform: uppercase; letter-spacing: 3px; margin-top: 10px; }
...
<footer style="background: #002244; color: white; padding: 40px 20px; text-align: center;">
